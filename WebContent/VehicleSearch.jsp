...
<body>
    <header>
        <nav class="navbar navbar-expand-md">
            <a class="navbar-brand" href="index.jsp">
                <img src="resource/legalcore-logo.png" alt=""> <span id="logo">OnlineTicketing</span>
            </a>
        ...
        <div data-aos="fade-right" data-aos-duration="1000">
            <h1>Trust And <br/> <span>Client Booking</span></h1>
        </div>
    </header>
    ...
    <section class="container my-5">
    	...
    	%>
    	<h4>Search Result for Vehicles of <span class="text-primary">"<%= category %>"</span> category</h4>
    	<%
    		for(HashMap advocate:advocates){
    	%>
    			<div class="bg-warning p-3 my-2" style="height: 140px;">
    				<div style="float:left;">
    					<p> 
    					Name: <b><%=advocate.get("name")%></b>
    					Email: <b><%=advocate.get("email")%></b>
    					Departure Time: <b><%=advocate.get("depttime")%></b>
    					Total time: <b><%=advocate.get("totaltime")%></b>
	    				</p>
	    				 <p> <%-- 
	    					Address: <b><%=advocate.get("address")%></b> --%>
	    					
    					Route: <b><%=advocate.get("route")%></b>
	    				</p> 
